...
SELECT *
FROM orders
WHERE standard_qty = 0 AND (gloss_qty > 1000 OR poster_qty > 1000)--I realized, i can use the () for limit WHERE
...
--I made mistake first for the WHERE (name LIKE 'C%' OR name LIKE 'W%'), for the because the capital letters
--So I investigated further and realized that some languages ​​don't care about that, while others do.